# src/api/services/yolo_service.py
...
from src.api.base_experiment import BaseExperiment
...
class YOLOExperiment(BaseExperiment):
    ...
    def process_data(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        with torch.no_grad():
            if isinstance(out, dict):  # Assuming NotDict is similar to a regular dict
